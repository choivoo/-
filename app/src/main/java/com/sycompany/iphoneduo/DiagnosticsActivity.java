...
public class DiagnosticsActivity extends Activity {
    ...
    private void build(){
        ...
        root.addView(DuoUi.label(this,"QE 1.2 • Quality Engine",12,Color.rgb(151,177,255),true));
    ...
    private String permissionInfo(){return"Home role: "+yes(home())+"\nSystem navigation: "+DuoNavigation.mode(this)+"\nNotification listener: "+yes(notifications())+"\nBrightness write: "+yes(Settings.System.canWrite(this));}
    private String qeVerdict(){int sw=getResources().getConfiguration().screenWidthDp;int base=sw>=900?8:sw>=720?7:sw>=600?6:4;int cols=base+DuoPrefs.grid(this);return"Layout columns: "+cols+"\nAdaptive mode: PASS\nPersistent icon order: PASS\nFolder/Dock engine: PASS\nGesture overlay: REMOVED\nGalaxy native gestures: "+DuoNavigation.mode(this)+"\nSystem UI replacement: SANDBOXED";}
